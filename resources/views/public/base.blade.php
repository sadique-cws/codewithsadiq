        ...
        <a class="navbar-brand" href="{{route('homepage')}}"><img src="{{ asset('newlogo.png') }}" alt=""></a>
          ...
          <div class="collapse navbar-collapse" id="navbarTogglerDemo02">
            <ul class="navbar-nav ml-auto mb-2 mb-lg-0">
              <li class="nav-item">
                <a class="nav-link  text-capitalize" href="{{route('homepage')}}" role="button" >Home</a>
              </li>
              <li class="nav-item dropdown">
                ...
                <li><a class="dropdown-item small" aria-current="page" href="{{route('cat',['slug'=>$cat->cat_slug,'id'=>$cat->id])}}">{{$cat->cat_title}}</a></li>
                  @endforeach
                </ul>
              </li>
              <li class="nav-item">
                <a class="nav-link  text-capitalize" href="#" role="button" >Sunday workshop <sup class='badge bg-danger small'>New</sup></a>
              </li>
              ...
              <li class="nav-item">
                <a class="nav-link  text-capitalize" href="#" role="button" >Contact</a>
              </li>
            ...
            <li class="nav-item dropdown  ml-5">
              <a class="btn btn-outline-success dropdown-toggle text-capitalize" href="#" id="navbarDarkDropdownMenuLink" role="button" data-toggle="dropdown" aria-expanded="false">
                {{Auth::user()->name}}
              </a>
              <ul class="dropdown-menu dropdown-menu-dark" style="z-index: 9999" aria-labelledby="navbarDarkDropdownMenuLink">
            ...
            <li class="nav-item"><a class="btn btn-outline-dark ml-2" aria-current="page" href="{{ route('cart')}}">
              <span class="float-left"> Cart</span>
              <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-cart float-right mt-1 ml-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
